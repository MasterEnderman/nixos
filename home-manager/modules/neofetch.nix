let
  config = ''
    ...
    print_info() {
        ...
        prin "​ ​​ $(color 6)  ​​​Ender's NixOS Configuration"
        prin "$(color 16)┌──────────────────────────────────────────┐"
    ...
    #    info "​ ​​ ​$(color 2)  Shell" shell
        ...
        info "​ ​​ ​$(color 4)  Theme" theme
        info "​ ​​ ​$(color 4)  Icons" icons
        info "​ ​​ ​$(color 4)  Terminal" term
    #    info "  $(color 4)  Font" font
    #    info "  $(color 4)  Terminal Font" term_font
    ...
    #    info "​ ​​ ​$(color 13)  GPU Driver  " gpu_driver  # Linux/macOS only
        ...
        info "​ ​​ ​$(color 13)  Disk" disk
        info "​ ​​ ​$(color 14)  Battery" battery
        # info "Song" song
        # [[ "$player" ]] && prin "Music Player" "$player"
        info "​ ​​ ​$(color 15)  Local IP" local_ip
